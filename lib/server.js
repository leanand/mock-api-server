...
'use strict';
var HELP_MESSAGE, Responder, ResponseSpecification, Server, cors, express, loadFiles, lumber, mockApiServer, parseJsonFiles, pick, ref,
...
HELP_MESSAGE = 'mock-api-server: A stand-in for a real API server Usage: mock-api-server --port PORT Options: --port PORT           The port to listen on (required).';
...
Server = (function() {
  ...
  Server.prototype.start = function(done) {
    ...
    return loadFiles('test/mock-api', (function(_this) {
